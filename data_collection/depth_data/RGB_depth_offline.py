...
def depth_rendering(FOLDER):
    ...
    for k, f in enumerate(FLAG):
        ...
        for Frame in range(len(target_state)):
            ...
            rgb_file1   = os.path.join(FOLDER, "RGB/%02d_%04d.png"%(f, Frame))
            rgb_file2   = os.path.join(FOLDER, "RGB/%02d_%04d.png"%(f, Frame))
            depth_file1 = os.path.join(FOLDER, "DepthMap/%02d_%04d.png"%(f, Frame))
            depth_file2 = os.path.join(FOLDER, "DepthMap/%02d_%04d.png"%(f, Frame))    
            ...
            for i in range(N_sample):
                ...
                ### save image and relative sates to disk
