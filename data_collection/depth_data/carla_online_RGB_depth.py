...
def main():
    ...
    try:
        ...
        camera.listen(lambda image: image.save_to_disk('./data_collection/depth_data/output/DepthMap/%02d_%04d.png' % (FLAG, frame)))
        ...
        camera_rgb2.listen(lambda image: image.save_to_disk('./data_collection/depth_data/output/RGB/%02d_%04d.png' % (FLAG, frame)))
    ...
    ##################### data collection ################################
        ...
        for frame in range(1000): 
            ...
            f_data = open('./data_collection/depth_data/output/data.txt','a+')
