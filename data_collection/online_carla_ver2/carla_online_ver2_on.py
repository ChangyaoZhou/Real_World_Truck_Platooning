...
def main():
    ...
    try:
        ...
        camera_rgb2.listen(lambda image: image.save_to_disk('./data_collection/online_carla_ver2/output/images_on/%06d.png' % frame))
        ...
        plt.title('on-trajectory data collection')
