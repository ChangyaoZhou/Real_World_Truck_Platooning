...
def main():
    ...
    try:
        ...
        camera_rgb2.listen(lambda image: image.save_to_disk('./data_collection/stereo_data/output/RGB1/%02d_%04d.png' % (FLAG, frame)))
        ...
        camera_rgb3.listen(lambda image: image.save_to_disk('./data_collection/stereo_data/output/RGB2/%02d_%04d.png' % (FLAG, frame)))
    ...
    ##################### data collection ################################
        ...
        for frame in range(1000): 
            ...
            f_data = open('./data_collection/stereo_data/output/data.txt','a+')
