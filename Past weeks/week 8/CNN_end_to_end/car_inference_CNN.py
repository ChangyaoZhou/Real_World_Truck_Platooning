...
# import for model
from model.my_models import MyModel_CNNalex, MyModel_CNNsimple, MyModel_CNN_alex_5output
...
FIG_SIZE = [8,8]
INPUT_SIZE = [400,400]
MODEL_PATH = './model/mynet_pretrained_alexnet.pth'
...
def main():
    ...
    try: 
        ...
        plt.xlim(-170, 400)
        ax.set_ylim([-410, -50])
        plt.xticks(np.arange(-170, 401, step=30))
