...
from output.control_lead_list import control_value_lead
...
def main():
    ...
    try:
        ...
        #camera_rgb2.listen(lambda image: image.save_to_disk('output/town04_image_data/images/%06d_%02d_%02d.png' % (frame,n+1,f+1)) if n >= 0 else None)
        camera_rgb2.listen(lambda image: image.save_to_disk('output/town04_image_data/images_on/%06d.png' % frame))
    ...
    ##################### data collection ################################
        ...
        for frame in range(801): 
            ...
            n = 0
            world.tick()
            vehicle_lead.apply_control(carla.VehicleControl(throttle=control_value_lead[frame+1][0],
                                                                steer=control_value_lead[frame+1][1]))
            ...
            if frame > 800 and frame % 10 == 0:
                ...
                for n in range(N_sample):                    
                    ...
                    for f in range(N_frame):   
                        ...
                        print('target vehicle throttle:', control_value_lead[frame+f+2][0])
                        ...
                        print('images/%06d_%02d_%02d.png' % (frame,n+1,f+1),
                ...
                f_data = open('./output/town04_image_data/ondata_image.txt','a+')
