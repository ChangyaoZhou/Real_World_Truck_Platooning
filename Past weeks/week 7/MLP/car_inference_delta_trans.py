...
# import for model
from model.my_models import MyModel1
...
def main():
    ...
    try: 
        ...
        plt.xlim(-200, 200)
        ax.set_ylim([-200, 200])
        plt.xticks(np.arange(-200, 201, step=20))
        plt.yticks(np.arange(-200, 201, step=20))
        plt.title('MPC 2D')
        ...
        '''
        text_pt = plt.text(-350, 70, '', fontsize=8)
        text_vlead = plt.text(-350, 60, '', fontsize=8)
        text_vfollow = plt.text(-350, 50, '', fontsize=8)
        text_dis = plt.text(-350, 40, '', fontsize = 8)
        text_yawlead = plt.text(-350, 30, '', fontsize = 8)
        text_yawfol = plt.text(-350, 20, '', fontsize = 8)
        text_ratio = plt.text(-350, 10, '', fontsize=8)
        
        text_list = [text_pt, text_vlead, text_vfollow, text_dis, text_yawlead, text_yawfol, text_ratio]
         
        control_values = []
        #mynet = MyModel1(neurons = [256, 1024, 2048, 1024, 256]) mynet2_4
        mynet = MyModel1(neurons = [128, 256, 256, 256, 128]) 
        print(mynet) 
