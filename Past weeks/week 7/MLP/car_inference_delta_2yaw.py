...
# import for model
from model.my_models import MyModel_2yaw
...
CAR_LENGTH = 3.7
FIG_SIZE = [8,8] 
MODEL_PATH = './model/mynet_2yaw.pth'
...
def main():
    ...
    try: 
        ...
        for point in world.get_map().get_spawn_points():
            print(point.location.x, point.location.y)
        print()
        ...
        plt.yticks(np.arange(-200, 201, step=50))
        plt.title('MPC 2D')
        ...
        # plot text 
        text_pt = plt.text(-200, -50, '', fontsize=10)
        text_vlead = plt.text(-200, -60, '', fontsize=10)
        text_vfollow = plt.text(-200, -70, '', fontsize=10)
        text_dis = plt.text(0, -50, '', fontsize=10)
        text_yawlead = plt.text(0, -60, '', fontsize=10)  
        text_yawfol = plt.text(0, -70, '', fontsize=10) 
        text_ratio = plt.text(0, -80, '', fontsize=10) 
        text_list = [text_pt, text_vlead, text_vfollow, text_dis, text_yawlead, text_yawfol, text_ratio]
         
        control_values = []
        mynet = MyModel_2yaw(neurons = [256, 1024, 2048, 1024, 256]) 
