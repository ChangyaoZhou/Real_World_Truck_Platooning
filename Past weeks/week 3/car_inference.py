...
# import for model
from model.my_models import MyModel
...
def main():
    ...
    try: 
        ...
        for frame in range(800):
            ...
            if frame == 0:
                ref_i = np.array(new_ref_lead)[:,None]
                state_i = np.array(new_ref_fol)[:,None]
            else:
            ...
            throttle, str_angle = mynet(model_input) 
