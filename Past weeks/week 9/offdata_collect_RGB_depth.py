...
def main():
    ...
    try:
        ...
        transform1 = world.get_map().get_spawn_points()[345] 
        ...
        camera.listen(lambda image: image.save_to_disk('output/on_trajectory/DepthMap/%02d_%04d.png' % (FLAG, frame)))
        ...
        camera_rgb2.listen(lambda image: image.save_to_disk('output/on_trajectory/RGB/%02d_%04d.png' % (FLAG, frame)))
    ...
    ##################### data collection ################################
        ...
        for frame in range(1000): 
            ...
            f_data = open('./output/on_trajectory/data.txt','a+')
