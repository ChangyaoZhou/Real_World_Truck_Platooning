...
def main():
    ...
    try: 
        ...
        #transform1 = Transform(Location(x=382.4937438964844, y=-230.1957244873047, z=0.0), Rotation(pitch=0.000000, yaw=88.0492935180664, roll=0.000000))
        ...
        #transform2 = Transform(Location(x=382.24652099609375, y=-238.58987426757812, z=0.0), Rotation(pitch=0.000000, yaw=89.36359405517578, roll=0.000000))
        ...
        spectator.set_transform(carla.Transform(transform2.location +carla.Location(z=600)+carla.Location(x=-80)+carla.Location(y=100),carla.Rotation(pitch=-90)))
        ...
        ax.set_ylim([-400, 0])
        plt.xticks(np.arange(200, 401, step=10))
        plt.yticks(np.arange(-400, 1, step=10))
        plt.title('MPC 2D')
        # Main plot info. 
        ...
        text_pt = plt.text(210, -120, '', fontsize=10)
        text_vlead = plt.text(210, -130, '', fontsize=10)
        text_vfollow = plt.text(210, -140, '', fontsize=10)
        text_dis = plt.text(300, -120, '', fontsize=10)
        text_yawlead = plt.text(300, -130, '', fontsize=10)  
        text_yawfol = plt.text(300, -140, '', fontsize=10) 
        text_ratio = plt.text(300, -150, '', fontsize=10) 
        '''
        text_pt = plt.text(210, -20, '', fontsize=10)
        text_vlead = plt.text(210, -30, '', fontsize=10)
        text_vfollow = plt.text(210, -40, '', fontsize=10)
        text_dis = plt.text(300, -20, '', fontsize=10)
        text_yawlead = plt.text(300, -30, '', fontsize=10)  
        text_yawfol = plt.text(300, -40, '', fontsize=10) 
        text_ratio = plt.text(300, -50, '', fontsize=10) 
        ...
        for frame in range(800):
            ...
            print('Yaw', vehicle_lead.get_transform().rotation.yaw)
            print('EGO Vehicle')
            ...
            print('Yaw', vehicle_follow.get_transform().rotation.yaw)
            ...
            #model_input = np.concatenate((ref_i[-1][None,:], state_i[-1][None,:]), axis = 1)
            mynet.eval()
